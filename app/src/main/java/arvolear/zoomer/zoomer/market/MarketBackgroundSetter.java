...
public class MarketBackgroundSetter extends BackgroundSetter
{
    public MarketBackgroundSetter(AppCompatActivity activity, String directory, int offset, int duration)
    {
