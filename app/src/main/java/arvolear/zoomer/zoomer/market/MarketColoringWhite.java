...
public class MarketColoringWhite extends MarketColoring
{
    private ColorFilter colorFilter;
    private Paint paint;

    public MarketColoringWhite(AppCompatActivity activity, int index)
    {
    ...
    private void init()
    {
        ...
        ColorFilterGenerator.invert(colorMatrix);
        ColorFilterGenerator.adjustSaturation(colorMatrix, (float)offset);
